...
{
	[Property, Sync , Group( "Movement" ), Feature( "Main" )] public float PlayerRunSpeed { get; set; } = 100f;
	[Sync,Property, Group( "Movement" ), Feature( "Main" )] public float PlayerWalkSpeed { get;  set; } = 100f; // Maximale Laufgeschwindigkeit
    [Sync,Property, Group( "Movement" ), Feature( "Main" )] public float MaxStamina { get;  set; } = 100f; // Maximale Ausdauer
    [Sync,Property, Group( "Movement" ), Feature( "Main" )] public float Stamina { get; private set; } = 100f; // Aktuelle Ausdauer
    [Sync,Property, Group( "Movement" ), Feature( "Main" )] public float StaminaPerSecond { get; set; } = 10f;
