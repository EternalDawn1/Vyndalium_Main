...
public partial class GeneralTask : GameResource
{
	...
	/// <returns></returns>
	public static GeneralTask GetRandomTask( TaskType taskType = TaskType.Any, TaskRarity taskRarity = TaskRarity.Any )
	{
